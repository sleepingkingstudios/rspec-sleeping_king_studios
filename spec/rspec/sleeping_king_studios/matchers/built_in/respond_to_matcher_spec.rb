...
RSpec.describe RSpec::SleepingKingStudios::Matchers::BuiltIn::RespondToMatcher do
  ...
  describe '#with_any_keywords' do
    ...
    it { expect(instance).to have_aliased_method(:with_any_keywords).as(:and_any_keywords) }
    it { expect(instance).to have_aliased_method(:with_any_keywords).as(:with_arbitrary_keywords) }
    it { expect(instance).to have_aliased_method(:with_any_keywords).as(:and_arbitrary_keywords) }
  ...
  describe '#with_unlimited_arguments' do
    ...
    it { expect(instance).to have_aliased_method(:with_unlimited_arguments).as(:and_unlimited_arguments) }
