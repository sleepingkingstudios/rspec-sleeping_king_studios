...
describe "fail with actual matcher" do
  ...
  let :instance do example_group.fail_with_actual actual; end
  ...
  context 'with false' do
    ...
    specify 'failure message' do
      ...
      expect(instance.failure_message_for_should_not).
        to eq "expected #{matcher} to match #{actual}"
    end # specify
    ...
    context 'with invalid string message' do
      ...
      specify 'failure message' do
        ...
        expect(instance.failure_message_for_should).to eq "expected" +
          " #{matcher} not to match #{actual} with message:\nexpected:" +
          " \"#{message}\"\nreceived: \"expected: true value\n" +
          "     got: false\""
      end # specify
    end # context
    ...
    context 'with valid regexp message' do
      let :message do /expected: true value/i; end
      let :instance do super().with_message message; end
