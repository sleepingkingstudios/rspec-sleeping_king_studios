# spec/rspec/sleeping_king_studios/matchers/rspec/pass_actual_spec.rb

require 'rspec/sleeping_king_studios/spec_helper'

require 'rspec/sleeping_king_studios/matchers/rspec/pass_actual'

describe "pass actual matcher" do
  let :example_group do RSpec::Core::ExampleGroup.new; end
  
  specify { expect(example_group).to respond_to(:pass_actual).with(1).arguments }
  
  let :actual do nil; end
  let :matcher do example_group.be_true; end
  let :instance do example_group.pass_actual actual; end
  ...
  context 'with true' do
    ...
    context 'with valid string message' do
      let :message do "expected: true value\n     got: true"; end
      let :instance do super().with_message message; end
    ...
    context 'with valid regexp message' do
      let :message do /expected: true/i; end
      let :instance do super().with_message message; end
